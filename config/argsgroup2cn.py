...
def perform_args2cfg(args,remain_redundant,dbg_print):
    ...
    from config.argsgroup_misgs import EvalParams,TrainParams,OptParams,ModParams,DataParams,RenderParams,ViewerParams
    from config.argsgroup_misgs import OTHER_PARAM_DICT
    ...
    cfg.expname = args.expname#jj
    cfg.model_path = args.expname#jj
...
def group_params_to_cfgnode(inputParam, groupParam_name = None,cfg = None):
    ...
    from config.argsgroup_misgs import GroupParams
